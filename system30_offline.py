...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run only the System30 offline branch-selection pass.")
...
def main() -> None:
    ...
    outputs = engine.run_offline_branch_ensemble(universe=universe)
    print('Offline System30 outputs:')
